...
variable "environment"  { type = string; default = "eks-prod" }
...
variable "db_engine_version"        { type = string; default = "16.6" }
...
variable "elasticache_num_replicas" { type = number; default = 0 }
